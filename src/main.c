...
void usage_message(void) {
  ...
  fprintf(stdout,
          "       --[no]lastwriter          Remove transitive dependences "
  ...
  fprintf(stdout,
          "       --innerpar                Choose pure inner parallelism over "
          "pipelined/wavefront parallelism [disabled by default]\n");
  fprintf(stdout,
  ...
  fprintf(stdout,
          "       --forceparallel=<bitvec>  6 bit-vector of depths (1-indexed) "
          "to force parallel (0th bit represents depth 1)\n");
  fprintf(stdout,
